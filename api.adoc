...
If you are trying to integrate OliveTin with your own scripts or processes, it's probably easiest to start actions by using an alias directly in the URL, <<api-eg-startIdUrl,see the example>>.
