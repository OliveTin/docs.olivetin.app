...
| `StartActionByGet`           | GET         | <<api-request-idurl,Action title alias in URL>>    | Log Entry (waits for the action to finish)
| `StartActionAndWait`         | POST        | <<api-request-obj,OliveTin request object>>        | Execution UUID
| `StartActionByGetAndWait`    | GET         | <<api-request-idurl,Action title alias in URL>>    | Log Entry (waits for the action to finish)
|======================================================
