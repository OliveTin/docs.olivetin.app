...
* The xref:troubleshooting/sosreport.adoc[SOS Report] includes the installed version.
...
* xref:troubleshooting/sosreport.adoc[SOS Report] — version is included or redacted based on this policy
