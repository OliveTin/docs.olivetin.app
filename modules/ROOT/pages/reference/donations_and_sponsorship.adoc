...
Another way that you can show your appreciation for OliveTin, that actually means a lot more than money, is to <<contribute,contribute to OliveTin>>. There are little ways and big ways to contribute - depends on if you have 2 minutes or 2 weeks to give! 
