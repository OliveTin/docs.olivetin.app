...
| regex:...                   | Version 2024.03.081 and above support custom regex patterns. See <<args-custom-regex,Custom regex arguments>>. 
...
| confirmation                | A "hidden" argument that makes the action require a confirmation before launching.
|===
