...
A calendar file is a list of instants (date + time) to run the action. Omce that instant is in the past, it will be ignored. 

You can use an action with a datetime argunent to update the calendar file. You will have to adjust the hardcoded timezone to suit your needs.gg
